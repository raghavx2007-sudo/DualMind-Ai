...
export default function PersonalAI() {
  ...
  const [messages, setMessages] = useState([
    {
      sender: "ai",
      text: "Hey 👋 I'm your Personal AI companion. Talk to me about your day, your plans, or anything on your mind.",
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const errorMsg = {
        sender: "ai",
        text: "⚠ I couldn't connect to the AI server. Please check if the backend is running.",
        time: new Date().toLocaleTimeString(),
      };
  ...
  return (
    ...
    <Layout>
      ...
      <div className="flex flex-col h-screen text-white p-6">
        ...
        <h1 className="text-2xl font-bold mb-4">Personal AI</h1>
        ...
        <div className="flex gap-4 mt-4 items-center">
          ...
          <button
            onClick={sendMessage}
            className="bg-purple-600 hover:bg-purple-700 w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition"
          >
